...
<head>
    ...
    <!-- SITE TITLE -->
    <title>Ceglédi extrém sportnap</title>
    <meta name="description" content="Ceglédi extrém sportnap"/>
    <meta name="keywords" content="extrém, extrémsport, sportrendezvény, cex, ceglédi extrém sportnap"/>
                        ...
                        <div id="navbar" class="navbar-collapse collapse">
                            <div class="lgx-nav-right navbar-right">
                                <div class="lgx-cart-area">
                                    <a class="lgx-btn" href="#">Nyereményjáték</a>
                                </div>
                            </div>
                            <ul class="nav navbar-nav lgx-nav navbar-right">
                                <li>
                                    <a class="lgx-scroll" href="index.html">Főoldal</a>
                                <li>
                                <li>
                                    <a class="lgx-scroll" href="#lgx-about">Rólunk</a>
                                <li>
                                    <a class="lgx-scroll" href="#lgx-speakers">Programok</a>
                                </li>
                                <li>
                                    <a class="lgx-scroll" href="#lgx-schedule">Időrend</a>
                                </li>
                                <li>
                                    <a class="lgx-scroll" href="#lgx-news">Blog</a>
                                </li>
                                <li>
                                    <a class="lgx-scroll" href="contact.html">Kapcsolat</a>
                                </li>
                            </ul>
                        </div><!--/.nav-collapse -->
                    </nav>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="lgx-banner-info"> <!--lgx-banner-info-center lgx-banner-info-black lgx-banner-info-big lgx-banner-info-bg--> <!--banner-info-margin-->
                                    ...
                                    <h2 class="title"> <span><b>2</b><b>0</b><b>2</b><b>4</b></span></h2>
                                    <h3 class="location"><i class="fa fa-map-marker"></i> Cegléd.</h3>
                        ...
                        <div class="col-md-offset-5 col-sm-12 col-md-7">
                            <div class="lgx-about-content-area">
                                <div class="lgx-heading">
                                    <h2 class="heading">Rólunk</h2>
                                    <h3 class="subheading">Ismerd meg az extrém világot!</h3>
                                </div>
                                <div class="lgx-about-content">
                                    ...
                                    <div class="section-btn-area">
                                        <a class="lgx-btn" href="about.html">bővebben</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="lgx-inner">
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="lgx-heading ">
                                <h2 class="heading">Programok</h2>
                                <h3 class="subheading">Változatos programok!</h3>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <!--//.ROW-->
                    <div class="section-btn-area">
                        <a class="lgx-btn lgx-btn-big" href="program.html"><span>további programok</span></a>
                    </div>
                </div>
                <!-- //.CONTAINER -->
            </div>
            ...
            <div class="lgx-inner">
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="lgx-heading">
                                <h2 class="heading">Időrend</h2>
                                <h3 class="subheading">Nézd meg a részletes időtervet!</h3>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="lgx-tab lgx-tab-vertical">
                                <ul class="nav nav-pills lgx-nav lgx-nav-nogap lgx-nav-colorful">
                                    <li class="active"><a data-toggle="pill" href="#home"><h3>Első <span>nap</span></h3> <p><span>29 </span>Nov, 2021</p></a></li>
                                    <li><a data-toggle="pill" href="#menu1"><h3>Második <span>nap</span></h3> <p><span>28 </span>Jul, 2021</p></a></li>
                                    <li><a data-toggle="pill" href="#menu2"><h3>Harmadik <span>nap</span></h3> <p><span>29 </span>Nov, 2021</p></a></li>
                    ...
                    <div class="section-btn-area schedule-btn-area">
                        <a class="lgx-btn lgx-btn-big" href="speakers.html"><span>Facebook esemény</span></a>
            ...
            <div class="lgx-inner">
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="lgx-heading">
                                <h2 class="heading">Galéria</h2>
                                <h3 class="subheading">Látnod kell, hogy elhidd!</h3>
                            </div>
                        </div>
                    </div>
                    <div class="row">
        ...
        <div id="lgx-news" class="lgx-news">
            <div class="lgx-inner">
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="lgx-heading">
                                ...
                                <h3 class="subheading">Lépj be a határok feszegetésének világába!.</h3>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="section-btn-area">
                        <a class="lgx-btn" href="news.html">További cikkek</a>
                    </div>
                </div><!-- //.CONTAINER -->
            </div><!-- //.INNER -->
        </div>
                ...
                <div class="container">
                    ...
                    <div class="lgx-footer-bottom">
                        <div class="lgx-copyright">
                            <p> <span>©</span> 2024 <a href="http://www.hegeshow.com/">Hegeshow.</a> minden jog fentartva. <a href="gdpr.html">GDPR.</a> <a href="afsz.html">ÁFSZ.</a> </p>
                        </div>
                    </div>
